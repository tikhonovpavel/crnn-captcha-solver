...
# training process
displayInterval = 20  # 100 # interval to be print the train loss
valInterval = 20  # 1000 # interval to val the model loss and accuray
saveInterval = 20  # 1000 # interval to save model
