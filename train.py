...
from custom_piecewise_affine_transform import CustomPiecewiseAffineTransform
...
if __name__ == "__main__":
    ...
    for epoch in range(params.nepoch):
        ...
        while i < len(train_loader):
            ...
            if i % params.displayInterval == 0 or i == 0:
        ...
        # save weights after every N epochs
        if epoch % checkpoint_every == 0:
            torch.save(crnn.state_dict(), '{0}/netCRNN_epoch{1}.pth'.format(params.expr_dir, epoch))
